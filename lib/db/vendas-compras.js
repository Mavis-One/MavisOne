...
function buildOrderQuoteRow(type, payload) {
  return {
    // Fase AV — ver o mapper acima. `dispensa_por/_em` sao gravados pelo
    // servidor no instante da dispensa, e nao vem da tela: quem dispensou e
    // quando sao fatos, nao campos de formulario.
