 ...
 *
 * O FORMATO NAO MUDOU: prefixo, milissegundos e 6 caracteres. Ids ja gravados
 * continuam validos, e nada que os leia precisa saber desta mudanca.
 */
function createId(prefix) {
  // 4 bytes -> 8 hex -> 6 caracteres, o mesmo tamanho de antes.
  const aleatorio = crypto.randomBytes(4).toString('hex').slice(0, 6);
