  ...
  for (let i = 0; i < itens.length; i += 1) {
    ...
    try {
      regra = await resolverRegraFiscal({
        ...
        ncm: item.ncm,
        // Fase CP — o mesmo critério que a emissão passa. Se a aba Impostos não
        // passasse o grupo, ela escolheria uma regra e a emissão outra, e a
        // pré-visualização deixaria de ser pré-visualização.
