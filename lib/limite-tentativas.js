...
//
// Sem banco e sem relógio próprio: o estado vive em memória e o instante entra
// por parâmetro, para o teste não depender de esperar.
//
// "Como as sessões", dizia aqui — e não diz mais: na fase CL elas foram para o
// banco, porque perdê-las num reinício deslogava o escritório inteiro. Este
// contador ficou, e a diferença é o que se perde quando o processo cai: ali era
// o login de todos, aqui é o placar de quem estava errando a senha. Perder o
// placar libera algumas tentativas a mais para quem estava sendo barrado; é
// custo pequeno e conhecido, não descuido. O que ele ainda impede está no
// comentário do exec_mode em ecosystem.config.js: em cluster, o contador por
// processo afrouxaria o limite sem avisar.
